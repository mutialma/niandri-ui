    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      <LightTable
        ...
        rows={[
          ...
          ['TGH-002','Sari Dewi',   'Penggantian Kabel Drop',  <span key="j" style={{fontFamily:'monospace',color:L.brand,fontWeight:700}}>Rp 75.000</span>,'01 Mei 2025', <Badge key="s" color="green">Lunas</Badge>],
        ]}
      />
      {showModal && (
